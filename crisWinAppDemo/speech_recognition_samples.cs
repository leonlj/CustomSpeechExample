...
namespace MicrosoftSpeechSDKSamples
{
    public class SpeechRecognitionSamples
    {
        ...
        public static async Task RecognitionWithMicrophoneAsync()
        {
            ...
            //ae524b10016343d2835be0c124b09117
            // for example var factory = SpeechFactory.FromSubscription("b38656.........", "eastasia");
        ...
        public static async Task RecognitionUsingCustomizedModelAsync()
        {
            ...
            // subscription key and service region. Replace with your own subscription key
            // and service region (e.g., "westus").
            // For example: var factory = SpeechFactory.FromSubscription("aa9.......... ", "westus");
            var factory = SpeechFactory.FromSubscription("YourSubscriptionKey", "YourServiceRegion");
            ...
            using (var recognizer = factory.CreateSpeechRecognizer())
            {
                ...
                // For example: recognizer.DeploymentId = "5080abac........";
